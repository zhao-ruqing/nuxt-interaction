...
.map-stage { position: absolute; inset: 0; }.map-loading { height: 100%; display: grid; place-items: center; color: var(--void-muted); background: #06090e; }
...
.toolbar-title { display: flex; flex-direction: column; width: 128px; flex: 0 0 auto; }.toolbar-title span { color: #f4ff58; font: 9px var(--void-mono); letter-spacing: .1em; }.toolbar-title strong { margin-top: 3px; color: var(--void-text); font-size: 15px; }
...
.point-list { flex: 1; overflow-y: auto; padding: 8px; }.point-item { width: 100%; padding: 13px 12px; color: var(--void-text); text-align: left; background: transparent; border: 1px solid transparent; cursor: pointer; transition: .2s; }.point-item:hover, .point-item.active { border-color: rgba(244,255,88,.28); background: rgba(244,255,88,.045); }.point-item__top, .point-item__data { display: flex; justify-content: space-between; gap: 8px; }.point-item__top b { font-size: 13px; }.point-item__top i { padding: 2px 5px; color: var(--void-muted); border: 1px solid var(--void-border); font: 9px var(--void-mono); font-style: normal; }.point-item__top i.is-published { color: #baff6a; }.point-item__top i.is-disabled { color: #ff8585; }.point-item__address { display: block; margin: 7px 0; overflow: hidden; color: var(--void-muted); font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }.point-item__data { color: rgba(255,255,255,.3); font: 9px var(--void-mono); }.point-item__data em { font-style: normal; }
.point-detail { position: absolute; z-index: 20; left: 16px; bottom: 54px; width: 350px; padding: 18px; }.detail-head { display: flex; justify-content: space-between; }.detail-head span { color: #f4ff58; font: 9px var(--void-mono); letter-spacing: .1em; }.detail-head h2 { margin: 6px 0 0; color: var(--void-text); font-size: 20px; }.detail-close { color: var(--void-muted); background: none; border: 0; font-size: 22px; cursor: pointer; }.point-detail > p { overflow: hidden; color: var(--void-muted); font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }.detail-metrics { display: grid; grid-template-columns: repeat(3,1fr); gap: 8px; margin: 16px 0 8px; }.detail-metrics small { display: block; margin-bottom: 5px; color: rgba(255,255,255,.3); font-size: 9px; }.detail-metrics strong { color: var(--void-text); font: 14px var(--void-mono); }.detail-actions { display: flex; justify-content: flex-end; margin-top: 10px; }
