...
<style scoped lang="scss">.social-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:40px}.social-grid h2,.xj-panel h2{margin-bottom:20px}.section-title{margin-top:36px}.social-row{display:flex;justify-content:space-between;align-items:center;padding:16px 0;border-bottom:1px solid rgba(255,255,255,.08)}.social-row p,.social-row span{color:rgba(255,255,255,.4)}.mini{margin-left:8px;padding:7px 10px;border:1px solid rgba(255,255,255,.2);background:none;color:#fff;border-radius:6px;cursor:pointer}.team-code{display:inline-block;margin:12px 0 20px;padding:12px 20px;border:1px dashed #f4ff58;color:#f4ff58;font:24px var(--void-mono)}.team-metrics{display:flex;gap:30px;margin:24px 0;color:rgba(255,255,255,.5)}</style>
